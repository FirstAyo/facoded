...
return (
    <>
        ...
        <article className="py-5 px-5 rounded-xl flex flex-wrap gap-10 w-[90%] mx-auto font-mono">

            {postSummaries.map((postSummary) => (

                <div key={postSummary.id} className='grow basis-[320px] flex-1 flex flex-col border-2 border-red-900 rounded-md px-5 py-5 relative'>
